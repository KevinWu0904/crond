...
func RegisterCrondServer(s grpc.ServiceRegistrar, srv CrondServer) {
	s.RegisterService(&Crond_ServiceDesc, srv)
}
...
// Crond_ServiceDesc is the grpc.ServiceDesc for Crond service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Crond_ServiceDesc = grpc.ServiceDesc{
